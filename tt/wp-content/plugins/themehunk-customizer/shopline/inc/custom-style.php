...
.footer-widget-column .widget ul li a, .footer-widget .product-title, .footer-widget .total strong, .footer-widget .widget span, .footer-widget .widget span.amount, #shopmain #wp-calendar thead th,.footer-widget .widget .textwidget p{color:{$footer_widget_text_color};}
